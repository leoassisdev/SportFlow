      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-8">
        ...
        <section className="mt-24 grid gap-16 md:mt-32 md:grid-cols-[1.4fr_1fr] md:items-center">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg text-ink-100">
              {APP_TAGLINE}
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {SPORTS.map((s) => (
                <div
                  key={s.key}
                  className="flex items-center gap-2 rounded-full border border-ink-800 bg-ink-900/70 px-4 py-2 text-sm font-medium text-ink-100"
                >
            ...
            <div className="card relative overflow-hidden">
              ...
              <div className="relative">
                <div className="mb-4 flex items-center justify-between">
                  <span className="badge animate-pulseGlow bg-accent-500 text-white">
                    AO VIVO
                  </span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-display text-4xl font-black text-brand-500">
                    ×
                  </span>
                  <div className="text-center">
                    <p className="text-xs uppercase tracking-widest text-ink-100">
